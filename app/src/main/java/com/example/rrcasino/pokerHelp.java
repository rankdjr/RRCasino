        ...
        public void onClick(View v) {
            switch(v.getId()) {
                case R.id.overviewBtn:
                    ...
                    helpDescription.setText(R.string.pOverviewDescription);
                ...
                case R.id.actionsBtn:
                    ...
                    helpDescription.setText(R.string.pActionsDescription);
                    helpDescription.setVisibility(v.VISIBLE);
                    break;
                case R.id.winningBtn:
                    helpTitle.setText(R.string.HowToWin);
                    helpTitle.setVisibility(v.VISIBLE);
                    helpDescription.setText(R.string.pWinningDescription);
                    helpDescription.setVisibility(v.VISIBLE);
                    break;
            }
        }
